                    ...
                    <div className="col-md-4 all-score-div">
                        ...
                        {this.state.single100data.map((single100, i) => 
                        {
                            ...
                            <LeaderSingleCard
                                ...
                                timestamp1={format(new Date(single100.date1),'MM/d/yyyy - kk:mm') }
                                score1={comma(single100.score1)}
                    ...
                    <div className="col-md-4 all-score-div">
                        ...
                        {this.state.multi100data.map((multi100, i) => 
                        {
                            ...
                            <LeaderMultiCard
                                ...
                                date={format(new Date(multi100.date),'MM/d/yyyy - kk:mm') }
                                score={comma(multi100.score)}
